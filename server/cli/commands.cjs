...
program
  ...
  .action(() => {
    ...
    console.info(
      "Example: node server/cli/commands.cjs seedPath or npm run cli seedPath",
    );
    console.info(
      "The following is a list of commands available with descriptions:",
    );
    console.info(
      "seedPath - You will be prompted for a file path to load into the database",
    );
    console.info(
      "seed <filepath> - enter the file path from your root directory to load the database",
    );
    console.info(
      "add - you will be prompted for the details of a car to add to the database",
    );
    console.info(
      "remove <_Id> - enter the entry id of a car you wish to remove from the database",
    );
    console.info("list - list all vehicles in the database");
    console.info(
      "find <keyword> - provide a single keyword to search the database for matches, e.g. green, toyota, sedan",
    );
    console.info(
      "wipe - Delete all entries in the database. You will be asked to confirm Y/N",
    );
  });
